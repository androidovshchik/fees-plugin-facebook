# fees-plugin-facebook

> Use Facebook SDK version 4 in Cordova projects

## Installation

See npm package for versions - https://www.npmjs.com/package/fees-plugin-facebook
...
```bash
$ cordova plugin add fees-plugin-facebook --save --variable APP_ID="123456789" --variable APP_NAME="myApplication"
```
